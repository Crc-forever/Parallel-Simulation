...
MODEL                   = Fridge_Correct
MODULES                 = Fridge_Correct.c Fridge_Correct_capi.c Fridge_Correct_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = Fridge_Correct.exe
MAKEFILE                = Fridge_Correct.mk
MATLAB_ROOT             = D:\matlabR2025a
ALT_MATLAB_ROOT         = D:\MATLAB~1
START_DIR               = D:\Benchmark\Pacemaker_correct
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Fridge_Correct_ref.rsp
