###########################################################################
## Makefile generated for component 'Quat'. 
## 
## Makefile     : Quat.mk
## Generated on : Thu Mar 19 00:26:37 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Quat.exe
...
COMPILER_COMMAND_FILE     = Quat_comp.rsp
CMD_FILE                  = Quat.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Quat.exe
...
DEFINES_STANDARD = -DMODEL=Quat -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Quat_ert_rtw\Quat.c

MAIN_SRC = $(START_DIR)\Quat_ert_rtw\ert_main.c
...
{$(START_DIR)\Quat_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Quat_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Quat_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Quat_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Quat.obj : "$(START_DIR)\Quat_ert_rtw\Quat.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Quat_ert_rtw\Quat.c"


ert_main.obj : "$(START_DIR)\Quat_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Quat_ert_rtw\ert_main.c"
