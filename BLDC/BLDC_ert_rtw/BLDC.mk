###########################################################################
## Makefile generated for component 'BLDC'. 
## 
## Makefile     : BLDC.mk
## Generated on : Thu Mar 19 00:31:58 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\BLDC.exe
...
COMPILER_COMMAND_FILE     = BLDC_comp.rsp
CMD_FILE                  = BLDC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\BLDC.exe
...
DEFINES_STANDARD = -DMODEL=BLDC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\BLDC_ert_rtw\BLDC.c

MAIN_SRC = $(START_DIR)\BLDC_ert_rtw\ert_main.c
...
{$(START_DIR)\BLDC_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BLDC_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BLDC_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BLDC_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
BLDC.obj : "$(START_DIR)\BLDC_ert_rtw\BLDC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\BLDC_ert_rtw\BLDC.c"


ert_main.obj : "$(START_DIR)\BLDC_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\BLDC_ert_rtw\ert_main.c"
