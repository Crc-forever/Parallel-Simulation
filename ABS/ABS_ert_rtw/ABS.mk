###########################################################################
## Makefile generated for component 'ABS'. 
## 
## Makefile     : ABS.mk
## Generated on : Thu Mar 19 00:46:48 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ABS.exe
...
COMPILER_COMMAND_FILE     = ABS_comp.rsp
CMD_FILE                  = ABS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ABS.exe
...
DEFINES_STANDARD = -DMODEL=ABS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\ABS_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ABS_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ABS_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ABS_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ABS.obj : "$(START_DIR)\ABS_ert_rtw\ABS.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ABS_ert_rtw\ABS.c"


ert_main.obj : "$(START_DIR)\ABS_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ABS_ert_rtw\ert_main.c"
