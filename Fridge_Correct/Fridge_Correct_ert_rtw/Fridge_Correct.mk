###########################################################################
## Makefile generated for component 'Fridge_Correct'. 
## 
## Makefile     : Fridge_Correct.mk
## Generated on : Thu Mar 19 21:37:53 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Fridge_Correct.exe
...
PRODUCT_NAME              = Fridge_Correct
MAKEFILE                  = Fridge_Correct.mk
MATLAB_ROOT               = D:\MATLAB~1
MATLAB_BIN                = D:\MATLAB~1\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = D:\Benchmark\Fridge_Correct
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Fridge_Correct_comp.rsp
CMD_FILE                  = Fridge_Correct.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Fridge_Correct.exe
...
DEFINES_STANDARD = -DMODEL=Fridge_Correct -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Fridge_Correct_ert_rtw\Fridge_Correct.c

MAIN_SRC = $(START_DIR)\Fridge_Correct_ert_rtw\ert_main.c
...
{$(START_DIR)\Fridge_Correct_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Fridge_Correct_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Fridge_Correct_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Fridge_Correct_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Fridge_Correct.obj : "$(START_DIR)\Fridge_Correct_ert_rtw\Fridge_Correct.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Fridge_Correct_ert_rtw\Fridge_Correct.c"


ert_main.obj : "$(START_DIR)\Fridge_Correct_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Fridge_Correct_ert_rtw\ert_main.c"
