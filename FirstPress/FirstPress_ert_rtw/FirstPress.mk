###########################################################################
## Makefile generated for component 'FirstPress'. 
## 
## Makefile     : FirstPress.mk
## Generated on : Thu Mar 19 00:29:25 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\FirstPress.exe
...
PRODUCT_NAME              = FirstPress
MAKEFILE                  = FirstPress.mk
MATLAB_ROOT               = D:\MATLAB~1
MATLAB_BIN                = D:\MATLAB~1\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = D:\Benchmark\CPU_Task
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = FirstPress_comp.rsp
CMD_FILE                  = FirstPress.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FirstPress.exe
...
DEFINES_STANDARD = -DMODEL=FirstPress -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\FirstPress_ert_rtw\FirstPress.c

MAIN_SRC = $(START_DIR)\FirstPress_ert_rtw\ert_main.c
...
{$(START_DIR)\FirstPress_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FirstPress_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FirstPress_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FirstPress_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
FirstPress.obj : "$(START_DIR)\FirstPress_ert_rtw\FirstPress.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FirstPress_ert_rtw\FirstPress.c"


ert_main.obj : "$(START_DIR)\FirstPress_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\FirstPress_ert_rtw\ert_main.c"
