###########################################################################
## Makefile generated for component 'CPUTask'. 
## 
## Makefile     : CPUTask.mk
## Generated on : Tue Mar 17 16:20:21 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CPUTask.exe
...
COMPILER_COMMAND_FILE     = CPUTask_comp.rsp
CMD_FILE                  = CPUTask.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CPUTask.exe
...
DEFINES_STANDARD = -DMODEL=CPUTask -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\CPUTask_ert_rtw\CPUTask.c

MAIN_SRC = $(START_DIR)\CPUTask_ert_rtw\ert_main.c
...
{$(START_DIR)\CPUTask_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CPUTask_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CPUTask_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CPUTask_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
CPUTask.obj : "$(START_DIR)\CPUTask_ert_rtw\CPUTask.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CPUTask_ert_rtw\CPUTask.c"


ert_main.obj : "$(START_DIR)\CPUTask_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\CPUTask_ert_rtw\ert_main.c"
