...
MODEL                   = CPUTask_Sim
MODULES                 = CPUTask_Sim.c CPUTask_Sim_capi.c CPUTask_Sim_data.c CPUTask_Sim_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = CPUTask_Sim.exe
MAKEFILE                = CPUTask_Sim.mk
MATLAB_ROOT             = D:\matlabR2025a
ALT_MATLAB_ROOT         = D:\MATLAB~1
START_DIR               = D:\Benchmark\CPU_Task\CPUTask_sim
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="D:\\matlabR2025a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = /LIBPATH:"D:\matlabR2025a\extern\lib\win64\microsoft" libmwsl_simtarget_instrumentation.lib libmwipp.lib libut.lib libmx.lib libmex.lib libmat.lib libmwmathutil.lib libmwslsa_engine.lib libmwslexec_simbridge.lib libmwsl_fileio.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib libmwsl_services.lib libmwsdi_raccel.lib libmwcoder_target_services.lib libmwcoder_ParamTuningTgtAppSvc.lib libmwslpointerutil.lib libmwfoundation_i18n_init_c_api.lib libfixedpoint.lib libmwslexec_simlog.lib libmwstringutil.lib
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = CPUTask_Sim_ref.rsp
COMPILER_COMMAND_FILE     = CPUTask_Sim_comp.rsp
